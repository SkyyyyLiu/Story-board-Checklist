...
1. 下载 [`ShotCheck.apk`](https://github.com/SkyyyyLiu/Story-board-Checklist/releases/latest) 安装到监视器或安卓手机
...
下载 [`ShotCheck.apk`](https://github.com/SkyyyyLiu/Story-board-Checklist/releases/latest)，在安卓监视器或手机上安装即可。
